...
void drawObject() {
  ...
  // Convert the distance from cm to pixels (adjusted for 100 cm max range)
  pixsDistance = iDistance * ((height - height * 0.1666) * 0.01); // Adjusted for 100 cm
  
  // Limit the range to 100 cm
  if (iDistance < 100) {
